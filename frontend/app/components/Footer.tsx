...
// ============================================================================
// SybilShield Frontend - Footer Component
// ============================================================================
...
const socialLinks = [
  ...
  {
    name: 'Twitter',
    href: 'https://twitter.com/sybilshield',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Discord',
    href: 'https://discord.gg/sybilshield',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
...
const footerLinks = [
  ...
  },
  {
    title: 'Community',
    links: [
      { name: 'GitHub', href: 'https://github.com/sybilshield' },
      { name: 'Discord', href: 'https://discord.gg/sybilshield' },
      { name: 'Twitter', href: 'https://twitter.com/sybilshield' },
    ],
  },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-dark-400 text-sm leading-relaxed max-w-sm mb-6">
              Privacy-focused, zero-knowledge proof-based system for fair DAO governance. 
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  className="p-2 rounded-lg bg-dark-800 text-dark-400 hover:text-accent-400 hover:bg-dark-700 transition-colors"
        ...
        <div className="mt-12 pt-8 border-t border-dark-800">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-dark-500">
              © {new Date().getFullYear()} SybilShield. All rights reserved.
            </p>
